...
public class Fact {
    ...
    // Constructor
    public Fact(BotClient botClient, MessageHandler messageHandler, SQL sql) {
        ...
        messageHandler.addCommand(new Command(description, name) {
            ...
            public void execute(TwitchMessageEvent event, ArrayList<String> args) {
                ...
                // Send message
                botClient.respond(event, getCommand(), trimMessage(sql.getAssetManager().getFact((isEnglish ? "en" : "de"))));
            }
        });
    }
}